...
|-------|------|----------|---------|-------------|
| `trust_remote_code` | `bool` | No | False | Whether to trust and execute remote code from model repositories. Set to True for models that require custom modeling code. Defaults to False for security. |
