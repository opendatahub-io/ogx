            ...
            **{  # type: ignore
                **torchtune_def,
                ...
                "pip_packages": (
                    ...
                    + [
                        "torch torchtune>=0.5.0 torchao>=0.12.0,<0.18.0 --extra-index-url https://download.pytorch.org/whl/cpu"
                    ]
                ),
            },
        ),
        InlineProviderSpec(
            **{  # type: ignore
                **torchtune_def,
                ...
                "pip_packages": (
                    cast(list[str], torchtune_def["pip_packages"]) + ["torch torchtune>=0.5.0 torchao>=0.12.0,<0.18.0"]
                ),
            },
        ),
        InlineProviderSpec(
